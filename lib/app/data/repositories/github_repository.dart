...
import 'package:flutter_getx/app/data/models/github_user_model.dart';
...
class GithubRepository {
  ...
  Future<List<GithubUserModel>> getGithubUsers() async{
    ...
    if (result.statusCode == 200) {
      result.data.map((item) => users.add(GithubUserModel.fromMap(item))).toList(); //Popula a lista com os mapas transformados em instância da classe.
    }
